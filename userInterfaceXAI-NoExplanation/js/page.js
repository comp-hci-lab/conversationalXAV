    ...
    methods: {
      ...
      read_the_next_data: function (this_file_name_) {
        $.ajax({
          ...
          success: function (myData) {
            ...
            //console.log("masterController.processData(myData)", masterController.processData(myData));
            metaData = myData;
            //console.log("the display is on");
          }
        });
      ...
      nextEvent: function () {
        if (this.$data.idx < TOTAL_NUM_EVENTS - 1) {
          ...
          console.log("done with nexEvent function, next get_the_next_data function ");
          let next_file_name = masterController.get_the_next_data(masterController.$data.idx + 1);
          console.log("next file name is:", next_file_name, "next function is read_the_next_data");
      ...
      async findFurthestStrings(strings, inputString) {
        ...
        let furthestStrings = similarities.slice(-3).map((entry) => entry.string);
      ...
      processData: async function (dataa) {
        ...
        //console.log("Data before split: " + dataa);
        //var lines = dataa.split(/\r\n|\n/);
        ...
        console.log("---this row---", values.length, headings.length, values);
        if (values.length < headings.length) {
          masterController.processData(dataa);
          console.log("This idx didn't work", this_idx, values.length);
          ...
          masterController.$data.q1_correct = values[5].replace(/"/g, '');
          ...
          masterController.$data.q4_correct = values[23].replace(/"/g, '');
          ...
          masterController.$data.q5_correct = values[24].replace(/"/g, '');
          ...
          masterController.$data.q6_correct = values[50].replace(/"/g, '');
          ...
          masterController.$data.q7_correct = values[3].replace(/"/g, '');
          ...
          masterController.$data.q8_correct = values[6].replace(/"/g, '');
          ...
          masterController.$data.q9_correct = values[7].replace(/"/g, '');
          ...
          masterController.$data.q10_correct = values[8].replace(/"/g, '');
          ...
          masterController.$data.q11_correct = values[25].replace(/"/g, '');
          ...
          masterController.$data.q12_correct = values[26].replace(/"/g, '');
          ...
          masterController.$data.q13_correct = values[27].replace(/"/g, '');
          ...
          cleaned_q14 = values[32].replace(/"/g, '');
          masterController.$data.q14_correct = cleaned_q14;
          ...
          masterController.$data.q15_correct = values[33].replace(/"/g, '');
          ...
          masterController.$data.q16_correct = values[35].replace(/"/g, '');
          ...
          masterController.$data.q17_correct = values[36].replace(/"/g, '');//yes-no
          ...
          masterController.$data.q18_correct = values[37].replace(/"/g, '');
          ...
          masterController.$data.q20_correct = values[39].replace(/"/g, '');//yes-no values[38]
          ...
          masterController.$data.q21_correct = values[51].replace(/"/g, '');
        ...
        console.log("end of process data function");
      },
      ...
      submitTask: function () {
        console.log("we are in submitTask function");
        ...
        if (masterController.checkUserInput("q1After") || masterController.checkUserInput("q2After") || masterController.checkUserInput("q3After") || masterController.checkUserInput("q4After") || masterController.checkUserInput("q5After") || masterController.checkUserInput("q6After") || masterController.checkUserInput("q7After") || masterController.checkUserInput("q8After") || masterController.checkUserInput("q9After") || masterController.checkUserInput("q10After") || masterController.checkUserInput("q11After") || masterController.checkUserInput("q12After") || masterController.checkUserInput("q13After") || masterController.checkUserInput("q14After") || masterController.checkUserInput("q15After") || masterController.checkUserInput("q16After") || masterController.checkUserInput("q17After") || masterController.checkUserInput("q18After") || masterController.checkUserInput("q19After") || masterController.checkUserInput("q20After") || masterController.checkUserInput("q21After")) {
          ...
          $.ajax({
            ...
            success: function (d) {
              ...
              console.log("end of logging data", "next to nextEvent function");
              masterController.nextEvent();
              console.log("it should not come back here");
