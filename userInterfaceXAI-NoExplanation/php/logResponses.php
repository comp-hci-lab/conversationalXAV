...
// Get the DB handle
try {
    $dbh = getDatabaseHandle('/Applications/XAMPP/xamppfiles/htdocs/userInterfaceXAI-NoExplanation/db/');
...
if ($dbh){
    ...
    $qryStr = "INSERT INTO userData (workerId, event_id, idx, file_name_to_be_processed, vid_name, q1_correct, q1_user, q2_correct, q2_user, q3_correct, q3_user, q4_correct, q4_user, q5_correct, q5_user,q6_correct, q6_user,q7_correct, q7_user,q8_correct, q8_user,q9_correct, q9_user,q10_correct, q10_user,q11_correct, q11_user,q12_correct, q12_user,q13_correct, q13_user,q14_correct, q14_user,q15_correct, q15_user,q16_correct, q16_user,q17_correct, q17_user,q18_correct, q18_user,q19_correct, q19_user,q20_correct, q20_user ,q21_correct, q21_user,q22_correct, q22_user ,q23_correct, q23_user,q24_correct, q24_user) VALUES
     (:workerId, :event_id, :idx, :file_name_to_be_processed,:vid_name, :q1_correct, :q1_user, :q2_correct, :q2_user, :q3_correct, :q3_user, :q4_correct, :q4_user, :q5_correct, :q5_user, :q6_correct, :q6_user,:q7_correct, :q7_user,:q8_correct, :q8_user,:q9_correct, :q9_user,:q10_correct, :q10_user,:q11_correct, :q11_user,:q12_correct, :q12_user,:q13_correct, :q13_user,:q14_correct, :q14_user,:q15_correct, :q15_user,:q16_correct, :q16_user,:q17_correct, :q17_user,:q18_correct, :q18_user,:q19_correct, :q19_user,:q20_correct, :q20_user ,:q21_correct, :q21_user,:q22_correct, :q22_user, :q23_correct, :q23_user,:q24_correct, :q24_user)";
