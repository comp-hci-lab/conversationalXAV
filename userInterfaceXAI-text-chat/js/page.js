...
userVehicleChat.push("thisisthenewchat/*/");
...
$(document).ready(function () {
  ...
  // Get a reference to the "no more" button
  const noMoreButton = document.getElementById("noMore");
  console.log("noMoreButton", noMoreButton)

  // Add a click event listener to the button
  noMoreButton.addEventListener("click", function() {
    ...
    if (confirmation) {
        // User clicked "yes," so call the function linked to this button
        masterController.noMoreQuestion()
    } else {
      console.log("user chaged their mind");
  ...
  var masterController = new Vue({
    ...
    methods: {
      ...
      showConfirmation: function() {
        console.log("we are inside the new function");
        // Display a confirmation dialog
        const confirmation = window.confirm("Are you sure?");
        console.log("confirmation", confirmation);
        // Check the user's response
        if (confirmation) {
          // User clicked "yes," so call the method to proceed to the next step
          masterController.noMoreQuestion();
        } else {
          // User clicked "no," do nothing
        }
      ...
      readExplanation: function() {
        document.getElementById("theVidDiv").style.pointerEvents = 'none';
        document.getElementById("theVidDiv").style.opacity = '0.4';
        document.getElementById("theVidDiv").style.marginLeft = '10%;';
        document.getElementById("robot-container").style.display = '';

        document.getElementById("static-prompt").style.display = "none";
